...
(function (root, factory) {
    ...
    var Imgur = function (options) {
        ...
        this.info = document.querySelectorAll('.image-info');
    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            ...
            input = this.createEls('input', {type: 'file', className: 'file-input', accept: 'image/*'});
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: 'https://cdn.onlinewebfonts.com/svg/img_300.png'});
